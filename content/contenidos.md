...
## La descripción de los datos  
 ...
 - Medidas resumen correspondientes a cada tipo de variable  
 - Distribuciones bivariadas  
 - Medidas de asociación según tipo de variable  
 - Visualización de datos: distribuciones simples y conjuntas  
 
 
## Inferencia estadística  
 - Parámetros de variables categóricas y cuantitativas  
 - Estimación de parámetros: error, riesgo, tamaño de muestra  
 - La varianza según el diseño muestral  
 - Pruebas de hipótesis: tipos de error, curva de potencia  
...
# Metodología
El curso se desarrolla de manera remota, por medio de encuentros sincrónicos a razón de un
encuentro por semana durante doce semanas. Período de dictado: marzo, abril y mayo de 2026  